 ...
 */
function getNodeImageProgram(drawLabel, drawHover) {
    var _a;
    /**
    ...
    function finalizePendingImages() {
        ...
        var drawRow = function (pendingImages) {
            ...
            pendingImages.forEach(function (_b) {
                var id = _b.id, image = _b.image, size = _b.size;
    ...
    return _a = /** @class */ (function (_super) {
            ...
            function NodeImageProgram(gl, pickingBuffer, renderer) {
                var _this = _super.call(this, gl, pickingBuffer, renderer) || this;
                rebindTextureFns.push(function () {
                    if (_this && _this.bindTexture) {
                        _this.bindTexture();
            ...
            NodeImageProgram.prototype.bindTexture = function () {
                var gl = this.normalProgram.gl;
                gl.bindTexture(gl.TEXTURE_2D, this.texture);
                gl.texImage2D(gl.TEXTURE_2D, 0, gl.RGBA, gl.RGBA, gl.UNSIGNED_BYTE, textureImage);
                gl.generateMipmap(gl.TEXTURE_2D);
            };
            NodeImageProgram.prototype.renderProgram = function (params, programInfo) {
                if (!programInfo.isPicking) {
                    // Rebind texture (since it's been just unbound by picking):
                    var gl = programInfo.gl;
                    gl.bindTexture(gl.TEXTURE_2D, this.texture);
                }
                _super.prototype.renderProgram.call(this, params, programInfo);
            };
            NodeImageProgram.prototype.processVisibleItem = function (nodeIndex, startIndex, data) {
            ...
            NodeImageProgram.prototype.setUniforms = function (params, _b) {
                var gl = _b.gl, uniformLocations = _b.uniformLocations;
                var sizeRatio = params.sizeRatio, pixelRatio = params.pixelRatio, matrix = params.matrix;
                this.latestRenderParams = params;
                var u_sizeRatio = uniformLocations.u_sizeRatio, u_pixelRatio = uniformLocations.u_pixelRatio, u_matrix = uniformLocations.u_matrix, u_atlas = uniformLocations.u_atlas;
